const translations = {
    en: {
        ...
        'var_init_deposit': 'Initial Deposit ($)',
        'var_act_deposit': 'Active Deposit ($)',
        'var_volume': 'Total Volume ($)',
        'var_points': 'Points',
        'var_rank': 'Rank',
        'var_win_rate': 'Win Rate (%)',
        'var_edit_btn': 'Edit data',
        'var_edit_title': 'VARIATIONAL / EDIT_DATA',
        'btn_save_edit': 'Save Changes',
        'var_input_date': 'Data entered',
        'variational_desc': 'Enter trading statistics manually. PNL and $/POINT will be calculated automatically.',
    ...
    uk: {
        ...
        'mean_win_rate': '03 // ВІДСОТОК ПЕРЕМОГ',
        ...
        'var_init_deposit': 'Початковий Депозит ($)',
        'var_act_deposit': 'Активний Депозит ($)',
        'var_volume': 'Загальний Об\'єм ($)',
        'var_points': 'Поінти',
        'var_rank': 'Ранг',
        'var_win_rate': 'Відсоток перемог (%)',
        'var_edit_btn': 'Редагувати дані',
        'var_edit_title': 'VARIATIONAL / РЕДАГУВАННЯ',
        'btn_save_edit': 'Зберегти',
        'var_input_date': 'Дата вводу',
        'variational_desc': 'Введіть торговельну статистику вручну. PNL та $/ПОІНТ розраховуються автоматично.',
